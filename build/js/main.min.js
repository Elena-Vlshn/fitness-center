...
window.addEventListener('DOMContentLoaded', function () {
  var tabButtons = document.querySelectorAll('.membership__button');
  var tabBodies = document.querySelectorAll('.membership__options-list');
  var videoGym = document.querySelector('.gym__video');
  ...
  function setupVideo(video) {
    ...
    var playButton = video.querySelector('.gym__button-play');
  ...
  function tabOpen(event) {
    var dataTabActiveName = event.target.dataset.tab;
    var bodyTabActive = document.querySelector("ul[data-tab=\"".concat(dataTabActiveName, "\"]"));
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        var _iterator2 = _createForOfIteratorHelper(tabBodies),
            _step2;

        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var tabBody = _step2.value;
  ...
  var sliderReview = new Swiper('.swiper-review', {
    slidesPerView: 1,
    slidesPerGroup: 1,
    loop: true,
    navigation: {
  ...
  var sliderTrainer = new Swiper('.swiper', {
    // Default parameters
    slidesPerView: 4,
    slidesPerGroup: 4,
    spaceBetween: 40,
  ...
  function onCardClick(event) {
    var trainersСard = event.target.closest('.trainers__card');
    var info = trainersСard.querySelector('.trainers__card-info');
    info.classList.toggle('trainers__card-inf--is-visible');
  }

  if (document.documentElement.clientWidth < 1200) {
    var trainersImages = document.querySelectorAll('.trainer-image');

    var _iterator4 = _createForOfIteratorHelper(trainersImages),
        _step4;
